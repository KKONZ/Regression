...
summary(fit <- lm(mpg~ wt + qsec + factor(am), data = mtcars))
...
Next test if there is a significant difference if automatic or manual transmissions make a difference using a wald test
